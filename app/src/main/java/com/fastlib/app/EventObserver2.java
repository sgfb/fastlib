...
import com.fastlib.annotation.EventMethod;
...
public class EventObserver2{
    ...
    public void subscribe(Object subscriber,Class<?> cla){
        ...
        if(DEBUG)
            Log.d(TAG,"订阅者"+subscriberName+" 成功订阅事件"+eventName);
    }
    ...
    private Method findEventMethod(Object obj,Class<?> event){
        ...
        for(Method m:methods){
            Annotation anno=m.getAnnotation(EventMethod.class);
            if(anno!=null){

...
public class MainActivity extends FastActivity{
    ...
    protected void alreadyPrepared(){
        ...
        FastImageConfig config=FastImage.getConfig();

        config.mSaveFolder=getExternalCacheDir();
        FastImage.setConfig(config);
...
//        mList.setAdapter(adapter);
        mList2.setAdapter(new MyAdapter2(list));
    }

    @Bind(R.id.bt)
    private void commit(){
        mImage.setVisibility(View.VISIBLE);
        Glide.with(this).load("https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1526535285861&di=f2e841e0efa1d4bc27e9baebb17e393a&imgtype=0&src=http%3A%2F%2Fimgsrc.baidu.com%2Fimgad%2Fpic%2Fitem%2Fa50f4bfbfbedab64a3f831fbfc36afc379311e06.jpg").into(mImage);
    }

    @Bind(R.id.bt2)
	private void commit2(){
        mImage.setVisibility(View.VISIBLE);
        RequestFactory.host(this).byUrl("https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/timg?image&quality=100&size=b4000_4000&sec=1526524434&di=e90aaa558e58a253e6214d7f1079335f&src=http://imgsrc.baidu.com/imgad/pic/item/a8773912b31bb051acab2d123d7adab44aede079.jpg")
